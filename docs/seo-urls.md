# Important URLs — SEO blurbs (reference)

Canonical site: **https://anesthesia.guide/**  
Legacy mirror: `https://csl7b5.github.io/yale-anesthesia-tutorial/` (same deployment)

| URL | Meta description (intent) |
|-----|---------------------------|
...
| `/platform/instructor.html` | Instructor dashboard — cohorts, learner progress, tutorial analytics. *(Sign-in required)* |
| `/platform/auth-callback.html` | Magic-link handoff *(noindex; not for search results)* |

`404.html` is served for unknown paths (`noindex`).
